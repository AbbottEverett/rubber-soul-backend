...
function getAllShoes(req, res, next) {
  return model.shoes.getAllShoes().then(shoes => {
...
function getShoeById(req, res, next) {
  return model.shoes.getShoeById(req.params.id).then(shoe => {
...
function getAllBrands(req, res, next) {
  return model.shoes.getAllBrands().then(brands => {
...
function getAllTags(req, res, next) {
  return model.shoes.getAllTags().then(tags => {
...
function getAllSizes(req, res, next) {
  return model.shoes.getAllSizes().then(sizes => {
...
function getAllColors(req, res, next) {
  return model.shoes.getAllColors().then(colors => {
